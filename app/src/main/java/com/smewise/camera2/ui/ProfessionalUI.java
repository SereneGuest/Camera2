 ...
 */
public class ProfessionalUI extends CameraBaseUI implements View.OnClickListener, TextureView
    ...
    public ProfessionalUI(Context context, Handler handler, CameraUiEvent event) {
        ...
        rootView = (RelativeLayout) LayoutInflater.from(context)
        ...
        mFocusLensBar = (AppCompatSeekBar) rootView.findViewById(R.id.sb_focus_length);
    ...
    private SeekBar.OnSeekBarChangeListener mFocusLensChangerListener =
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            eventListener.onSettingChange(CaptureRequest.LENS_FOCUS_DISTANCE, value);
        }
